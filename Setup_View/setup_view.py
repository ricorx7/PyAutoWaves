...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 515, 227))
        ...
        self.verticalLayout_4.addWidget(self.recordPushButton)
        ...
        self.verticalLayout_4.addWidget(self.bytesWrittenLabel)
    ...
    def retranslateUi(self, Setup):
        ...
        self.recordPushButton.setText(_translate("Setup", "RECORD"))
