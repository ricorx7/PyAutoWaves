...
class Ui_Terminal(object):
    def setupUi(self, Terminal):
        ...
        self.gridLayout.addWidget(self.clearConsolePushButton, 3, 0, 1, 1)
        self.totalBytesWrittenLabel = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.gridLayout.addWidget(self.totalBytesWrittenLabel, 2, 0, 1, 1)
